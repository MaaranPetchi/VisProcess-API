...
using TimeZone = VisProcess.Models.TimeZone;

namespace VisProcess.Services;

public partial class VisTestContext : DbContext
{
    public VisTestContext()
    {
    }

    public VisTestContext(DbContextOptions<VisTestContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=KTP-DT-KIT008;Initial Catalog=VIS_Test;Persist Security info=False;User ID=sa;Password=Password@1;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=True; ");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<EmployeeAssign>(entity =>
        {
            ...
            entity.HasOne(d => d.JidNavigation).WithMany(p => p.EmployeeAssigns)
                .HasForeignKey(d => d.Jid)
                .HasConstraintName("FK__EmployeeAss__JId__65C116E7");
            ...
            entity.HasOne(d => d.Wfm).WithMany(p => p.EmployeeAssigns)
                .HasForeignKey(d => d.Wfmid)
                .HasConstraintName("FK_EmployeeAssign_ProcessWorkFlowMaster1");
