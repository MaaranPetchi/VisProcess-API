...
namespace VisProcess.Services
{
    ...
    public class TableWork : IDisposable
        {
            private VisTestContext context = new VisTestContext();
        ...
        public TableWork()
        {
           ...
           // private IRepository<Vis.VleadProcessV3.Models.TimeZone> timezoneRepository;
            ...
            //private IRepository<tbl_ITAssetHardware> Tbl_ITAssetHardwareRepository;//----------------------slowness bugs fixed-----------------------------
            //private IRepository<tbl_ITAssetSoftware> Tbl_ITAssetSoftwareRepository;//----------------------slowness bugs fixed-----------------------------
            //private IRepository<Skillset> skillsetRepository;//-----------------------------------------ESs---------------------
            //private IRepository<EmployeeSkillset> employeeskillsetRepository;//---------------------ESs----------------------
            ...
            //------------------------------------------final CL---------------------------------------------------------------------
            //-----------------------------------------slowness bugs fixed--------------------------------------------------------------------------
            //public IRepository<tbl_ITAssetHardware> tbl_ITAssetHardwareRepository
            //{
            //    get
            //    {
            //        if (this.Tbl_ITAssetHardwareRepository == null)
            //        {
            //            this.Tbl_ITAssetHardwareRepository = new Repository<tbl_ITAssetHardware>(context);
            //        }
            //        return Tbl_ITAssetHardwareRepository;
            //    }
            //}
            //public IRepository<tbl_ITAssetSoftware> tbl_ITAssetSoftwareRepository
            //{
            //    get
            //    {
            //        if (this.Tbl_ITAssetSoftwareRepository == null)
            //        {
            //            this.Tbl_ITAssetSoftwareRepository = new Repository<tbl_ITAssetSoftware>(context);
            //        }
            ...
            //    }
            //}
            //public IRepository<EmployeeSkillset> EmployeeskillsetRepository
            //{
            //    get
            //    {
            //        if (this.employeeskillsetRepository == null)
            //        {
            //            this.employeeskillsetRepository = new Repository<EmployeeSkillset>(context);
            //        }
